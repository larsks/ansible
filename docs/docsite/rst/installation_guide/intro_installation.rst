...
.. note::
    ...
    Ansible. See the Python documentation on `installing to the user directory`_ for more information.

.. _installing to the user directory: https://packaging.python.org/tutorials/installing-packages/#installing-to-the-user-site
